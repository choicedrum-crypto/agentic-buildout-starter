...
const config = node({
  ...
  config: {
    ...
    parameters: {
      ...
      assignments: {
        assignments: [
          { id: 'config-object', name: 'config', type: 'object', value: expr('{{ { dry_run: true, enable_schedule_processing: false, enable_outlook_patch: false, batch_limit: 25, tier3_confidence_threshold: 0.65, slack_exception_channel: "#workflow-builder", audit_table: "inbox_classifications", ms_user_email: "dbradley@tciallc.com", classifier_mount_path: "/data/classifier", tier3_provider: "dbhub_local_llm", local_llm_base_url: "http://100.66.221.24:4000", local_llm_model: "local-coder", local_llm_credential: "DBHub LiteLLM", enable_tier3_local_llm: false, outlook_category_map: { Q1: "Q1: Do Now", Q2: "Q2: Schedule", Q3: "Q3: Delegate", Q4: "Q4: Eliminate", QR: "QR: Quarantine" }, readiness: { outlook_credential: "Microsoft Outlook account", local_llm_credential: "pending DBHub LiteLLM httpHeaderAuth credential", postgres_credential: "pending", local_llm: "endpoint reachable from n8n; model local-coder tested on dbhub" } } }}') }
        ]
      }
    }
  }
